...
TEXTS = {
    "en": {
        ...
        "description": "This machine learning application uses XGBoost and key nutritional features to perform nutrition quality assessment of ready foods based on HSR-generated labels. The main point is that a small set of routinely labelled nutrients can closely approximate HSR-defined nutrition quality ratings.",
        "target_audience": "🎯 Target Audience",
        "audience_desc": "Designed for countries with limited nutritional information, where a complete Health Star Rating cannot be calculated from pack information alone.",
        ...
        "mission": "🚀 Mission",
        "mission_desc": "Providing a practical approach for countries with incomplete nutritional information: a small set of on-pack nutrients can still closely approximate HSR-generated nutrition quality assessment when a full HSR cannot be calculated.",
        ...
        "input_tip": "💡 Tip: Please enter the nutritional information of the food, and the system will give the HSR-generated nutrition quality class.",
    ...
    "zh": {
        ...
        "mission": "🚀 使命",
        "mission_desc": "为营养信息不全、无法直接计算完整HSR的国家提供一个使用思路：用少量包装营养素近似HSR生成的营养质量评估。",
        ...
        "input_tip": "💡 提示：请输入食品的营养成分信息，系统将给出基于HSR生成的营养质量类别。",
